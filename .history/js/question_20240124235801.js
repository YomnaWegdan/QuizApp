...
export default class Question{
    ...
    checkAnswer(e){
        if(!this.answered){  //if not answered
            this.isAnswered=true   //make it answered
    ...
    animateQuestion(ele){
      setTimeout(()=>{
        ele.closest('.question').classList.add('animate__animated' , 'animate__bounceOutLeft')  //when click on answer => take parent move it to left
      },500)
      this.n
    }
}
